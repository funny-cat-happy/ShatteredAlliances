...
-- hostage in guard stations.
	...
	OPERATOR_SCANNERS_DETECTED_1 = "Incognita has detected multiple ECCM signals. There must be some of FTM's powerful scanning devices in the complex.",
	OPERATOR_SCANNERS_DETECTED_2 = "They will detect your team's location each alarm level, make sure to shut them all down.",
	OPERATOR_SCANNERS_DETECTED_3 = "Good job, Operator. You won't need to worry about those anymore.",
    ...
    OBJ_SCANNERS = "Disable the scanners",
