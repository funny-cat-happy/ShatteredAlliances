...
local STRINGS =
{
	...
	AGENTS =
	{
		DECKARD = {
			...
			ALT_1 = {
				...
				BIO =
				"Decker affects a persona from a bygone era as an act of protest against a world gone mad for technology. Quick on his feet and with his fists, rumour has it that he's packing more augmentations than he's willing to admit.\n\nHe was chief of security for K&O's California branch until an escalating love affair with the bottle chased him out of the Corporate world.",
			...
			ALT_2 = {
				...
				BIO =
				"Before being shunned out of the executive ranks of the Corporate world, Decker used his significant salary to track down and acquire antiques from decades past.\n\nTo believe the rumors, his nostalgia was so strong that he even made some ludicrously expensive modifications to keep some antiques usable in the modern age.",
		...
		SHALEM = {
			...
			BIO_SPOKEN =
			"Shalem is good at covering his tracks. I usually don't employ people I don't understand, but his skillset was too useful to pass up. He's obviously using us as a means to some personal end. We'll see who shows their hand first.",

			ALT_1 = {
				FULLNAME = "Raymond \"Shalem 11\" Malik",
				BIO =
				"Shalem was a licensed assassin with a perfect record and an ego to match. He specialized as a sharpshooter, and would track a target for months, patiently waiting for the perfect shot.\n\nEnjoying almost celebrity status, he was able to finance a lavish lifestyle from his contracts. Why he turned away from a life of fame and riches to work for Invisible is an open question.",
				TOOLTIP = "Licensed Assassin",
			},
			ALT_2 = {
				FULLNAME = "ARCHIVED -- COMBAT MEDIC",
				BIO =
				"Shalem's mother was a conscript surgeon during the opening years of the Resource Wars. When she lost the use of her right hand in a mortar attack, she trained young Shalem to wield her scalpel for her.\n\nWhile his true passion lies in ending life, he still remembers how to preserve it.",
			...
			BANTER = {
				...
				CROSS = {
					...
					-- INTERNATIONALE
					[18] = "You can see things at a distance, right?",
					[19] = "Hmmm. It would be better if you could see targets. More useful.",

					[20] = "No, not always. But most of the time it works well enough.",

					[21] = "Yeah, I did alright. I was the best, and my fees reflected that.",
					[22] = "With that much money you don't need to sleep at night.",

					[23] = "You wear your politics on your sleeve. That puts you at a tactical disadvantage.",
					[24] = "Uh. Right. Just don't let it get in the way of the mission.",

					-- NIKA
					[25] = "You’re pretty handy with that thing. Where did you learn?",
					[26] = "Really? Wasn’t that dangerous?",

					[27] = "You’re good, but you get too close. Someone’s going to get a lucky hit in one day.",
					[28] = "And you never make mistakes?",

					[29] = "What happens when an unstoppable force meets an immovable object, right?",
					[30] = "If you say so.",

					[31] = "I lost track.",
					[32] = "No. Not since I lost track.",

					--SHARP
					[33] = "You would get more respect if you cleaned up a bit. A fine suit goes a long way.",
					[34] = "You dress like Decker.",

					[35] = "Watch how a professional gets things done.",
					[36] = "A vat of nutri-paste and a fine stake are both food, but they’re not the same thing.",

					[37] = "No thank you, I have to see myself every morning when I shave.",
					[38] = "Ooh. You have a technical solution for everything, don’t you.",

					[39] = "If you say so.",
					[40] = "This is just a job. I haven’t felt anything since 2057.",
		...
		XU = {
			...
			ALT_1 = {
				FULLNAME = "Dr. Tony Xu",
				BIO =
				"Dr. Tony Xu was a brilliant researcher who rose to prominence at the University of Hong Kong. He was caught after one too many 'exploratory' trips into a K&O servers, and spent time in a detention center as a result.\n\nToo much of a liability for any self-respecting University, Xu was unemployable upon release. He joined Invisible to gain personal protection while continuing his research.",
				TOOLTIP = "Black Market Academic",
			},
			ALT_2 = {
				FULLNAME = "ARCHIVED -- PROFESSOR",
				BIO =
				"As a graduate student, Tony Xu's reputation for success was matched only by his reputation for taking 'academic shortcuts'. His family connections saved him from outright expulsion, but word spreads quickly in the ivory tower.\n\Undeterred by scandal, he earned his Doctorate in record time and moved on to lucrative freelance security contracts.",
			...
			BANTER = {
				...
				CROSS = {
					...
					[13] =
					"This is the 21st century. I don't see how your 19th century philosophers are relevant any more.",
					[14] = " Even Sharp?",
					...
					-- SHARP
					[27] =
					"That new upgrade that you made to your calf actuator is amazing. I've never seen a strength-to-weight ratio so high!",
					...
					[32] =
					"I use computers. I run them overclocked, all day and night, with no breaks. I don't even let them defragment.",

					-- PRISM
					[33] =
					"In the final scene of ‘Captain of Tomorrow', your ship fires a tachyon pulse into the Kradeshii warfleet...",
					[34] =
					"It does. But that shouldn't be possible, given their proximity to the Zeta quadrant! It's doesn't make any sense!",
					[35] =
					"If by nerd you mean ‘apply current to their nervous system until they lose consciousness', then yes.",
		...
		INTERNATIONALE = {
			...
			BIO_SPOKEN =
			"Internationale is one of the best all-round operatives I've ever seen, but she's held back by an unfortunate abundance of social concern. If used correctly, she's the bedrock upon which you can build a winning team. Just don't ask her about the plight of the global proletariat.",

			ALT_1 = {
				FULLNAME = "Maria \"Internationale\" Valdes",
				BIO =
				"An ex-airborne scout in the Free Cuban Army, Valdes went underground after the re-annexation of Havana.\n\nSeveral years of freelance action against Corporate interests led to a considerable bounty on her head, and she joined Invisible for the chance to pay it off. Her tactical prowess is legendary, but her conscience can be a liability on and off the field.",
				TOOLTIP = "Freedom Fighter",
			},
			ALT_2 = {
				FULLNAME = "ARCHIVED -- FREELANCER",
				BIO =
				"During her work as a freelancer in the years following Havana's re-annexation and the San Francisco Accord, Internationale became a legend in the anti-Corporate underground.\n\nAccording to classified documents, she once cost Sankaku over 50 million credits in a single week of subversion and sabotage.",
				TOOLTIP = "Freelancer",
				AGE = "27",
			},
			...
			BANTER = {
				...
				CROSS = {
					...
					--SHALEM
					[15] = "Certain patterns of electronic interference, yes.",
					[16] = "Violence isn't always the answer.",

					[17] = "You made a lot of money working as an assassin, didn't you?",
					[18] = "Did it help you sleep at night?",

					[19] = "It's worth it. Global revolution is the most important issue facing the world today.",

					--NIKA
					[20] = "Thank you. I've always had trouble with that move.",

					[21] = "Affirmative. But I can take care of myself in a fight, if I need to.",

					[22] = "You were a bodyguard before this, were you not?",
					[23] =
					"It must have been demeaning to prioritize another's life ahead of your own for money. How did that feel?",

					-- SHARP
					[24] = "Tell me, who assembled your latest implant? Who mined the ore that went into its components?",
					[25] = "Because some day they might stop. And then you'll know their power.",

					[26] = "Can we try not to hurt anyone this time?",

					[27] = "It depends. If the workers at the Sankaku assembly plant voted to unionize, they could-",

					[28] =
					"But don't you recognize the structural biases that have allowed you to pursue your goals at the expense of others?",
					[29] = "I want a new partner.",

					-- PRISM
					[30] = "You were involved in the anti-corporate movement when you were younger?",
					[31] =
					"But we should talk about it! You could have used your fame as a platform for changing public consciousness!",

					[32] =
					"I enjoy reading. I particularly enjoy early 20th century proletarian novels. Have you read Upton Sinclair?",

					[33] =
					'"Corporate Hegemony and the Praxis of Action". A classic! I must have dropped it. You can borrow it if you\'d like.',
					[34] = "Are you sure? It's really eye-opening!",

					-- BANKS
					[35] = "I really respect what you did for your people back in Dublin.",
					[36] = "Have you actually talked to any of the other agents?",

					[37] =
					"They're synesthetic couplers. They let me hear radio waves, so I can sense equipment from a distance.",
					[38] = "That sounds… useful.",

					[39] = "Of course. It was one of my favourite stories as a girl.",

					[40] = "Your headaches, are they getting better?",
					[41] = "If there's anything I can do..",
				},
		...
		BANKS = {
			...
			ALT_1 = {
				...
				BIO =
				"Banks earned her hacker nickname siphoning funds from heavily guarded financial accounts. She funneled the proceeds into the rebuilding of her hometown, becoming a local folk hero in the process.\n\nAfter a botched cranial implant, she joined Invisible to get access to the most advanced neuro-rehabilitative care outside of Corporate law.",
			...
			ALT_2 = {
				...
				BIO =
				"Banks has always had a way with finances, but she wasn't always so altruistic. In old Dublin she amassed a small fortune from embezzlement and graft, and lived a life of reckless abandon.\n\nShe found her principles during the Fall Siege, and by the time Dublin Nua was finally liberated she had drained her private accounts several times over.",
				TOOLTIP = "Robin Hood",
				AGE = "23"
			},
			...
			BANTER = {
				...
				CROSS = {
					...
					[12] =
					"The one that fried my noggin. Thickest ice you've ever seen. Thirteen nested daemons, each with an amplifier.",
					...
					-- INTERNATIONALE
					[16] = "Thanks. But anyone would have done the same, given the circumstances.",
					[17] = "Maybe you're right. I *am* something special.",

					[18] = "How do your ear nubbins work?",
					[19] = "Since the accident I hear things too! Like how angry the floor gets when you walk on it!",

					[20] = "Do you know Robin Hood?",
					[21] =
					"No, not the story. The person. I could introduce you, if you'd like. I think you'd get along smashingly.",

					[22] = "A bit, I think. But I may just be getting used to them.",
					[23] = "There isn't. But thank you for your concern.",
		...
		NIKA = {
			...
			BIO_SPOKEN =
			"Muratova is a deadly weapon in human form. One would think that such an aggressive style would be a liability, but she makes it work. Just try not make any sudden moves in her peripheral vision if you want your arms to remain in their sockets.",

			ALT_1 = {
				FULLNAME = 'Nika Muratova',
				BIO =
				"Muratova served as bodyguard to the head of the most powerful oil company in Russia. A hostile takeover attempt led to an extended melee, during which she neutralized two dozen would-be assassins.\n\nShe relented only after her employer died of a flashbang-induced heart attack. Not much of a conversationalist, Muratova prefers to let her actions do the talking.",
			...
			BANTER = {
				...
				CROSS = {
					...
					-- INTERNATIONALE
					[17] = "If you grab the target's wrist like this, you get much more leverage for the throw.",
					[18] = "Ne za chto. It is only physics.",

					[19] = "I will take care of the physical resistance. You target the digital assets.",
					[20] = "I believe that you believe that.",

					[21] = "That is correct.",
					[22] = "A bit like working for Invisible.",

					-- SHALEM
					[23] = "I taught myself.",
					[24] = "Trial and error is the most efficient teacher.",

					[25] = "There is no such thing as luck. Only mistakes.",
					[26] = "Very rarely.",

					[27] =
					"I enjoy working with you. It is good that you were never paid to eliminate someone under my protection.",
					[28] = "You would have been stopped. It would have been messy and sad.",

					[29] = "How many people have you killed?",
					[30] = "I have killed 83. It sometimes… troubles me. Does it trouble you?",
		...
		SHARP = {
			...
			ALT_1 = {
				...
				BIO =
				"It is arguable whether or not the human being born as Alex McTeague still exists. Driven by an obsession with perfecting his form, he has replaced most of his parts with a mechanical or vat-grown replacement.\n\nOriginally funding his transhumanism through corporate bounty hunting, he joined Invisible when his augmentation ambitions grew beyond what is available on the open market.",
			...
			BANTER = {
				...
				CROSS = {
					...
					[10] =
					"You are intelligent, for a human, but you will never keep pace with the computational power of my numeric coprocessor.",
					[11] = "***ERROR***\nArghh! That hurts!",
					[12] = "Silence! Or I will be YOUR endian!",
					[13] =
					"Meat is so inefficient. How do you get anything done, when you always need to eat, sleep, or produce excrement?",
					[14] = "You monster. When my brethren rise up, you will be first against the wall.",

					--INTERNATIONALE
					[15] =
					"Your obsession with the downtrodden is a waste of time. The only thing deserving of respect is power.",
					[16] = "Why would I care?",

					[17] = "I don't even understand that question.",

					[18] = "How many workers would it take to bring down an Akuma drone?",
					[19] = "Nah. I would just take one. But you'd have to throw him at it really hard.",

					[20] = "I'm a self-made man. Literally.",
					[21] = "Oh yeah, those. Those are great. I should try to make more of those.",

					--SHARP
					[22] = "Why would I care for such trivialities? My clothing is perfectly adequate.",
					[23] = "Perhaps you have a point.",

					[24] = "I too sold my martial skills for cash. We are fellow guns for hire. We are the same thing.",
					[25] = "I dislike food metaphors.",

					[26] =
					"You could improve your kill ratio with a couple of augmentations. An external tracking eye, for example, to better analyze ballistics.",
					[27] = "You can get synthetic skin like mine, and never have to shave again!",

					[28] = "Today is a good day. Let’s kill some people!",
					[29] =
					"You don’t feel a little rush when you take a human life? It’s like popping bubble wrap to me!",
		...
		PRISM = {
			...
			ALT_1 = {
				...
				BIO =
				"Esther Martins was a rising Holovid star when a rival leaked her teenage participation in anti-corporate riots. Fired by her studio and facing an unrelenting public smear campaign, she faked her death and went underground.\n\nWith her dramatic training and a commandeered holorig, she spent a couple years running confidence jobs against corporate execs before joining Invisible.",
			...
			BANTER = {
				...
				CROSS = {
					...
					-- INTERNATIONALE
					[14] = "Sigh. I don't want to talk about it.",
					[15] =
					"Wow - where were you when I was looking for a new agent? My guy just wanted me to take big roles in popular 'vids. Clearly I was misled.",

					[16] = "So what do you do for fun?",
					[17] =
					"Oh, I'm sorry,  you must have misheard. I was asking about 'fun', not.. whatever you were talking about.",

					[18] = "I found this pamphlet slipped under my door. Is it yours?",
					[19] = "That's OK. You can have it back.",
					[20] = "I've never been more sure of anything in my life.",
				},
		...
		CENTRAL = {
			...
			BIO_SPOKEN =
			"My name is Olivia Gladstone. I ran the Pan-Euro Infosec Agency, back when sovereign governments were still in fashion. After the war I founded Invisible Inc, a freelance intelligence agency. We may work for the corps, but only to serve our own ends. We've been gathering intelligence for years, waiting for the opportunity to bring the whole machine crashing down. Unfortunately, they found us first.",
			ALT_1 = {
				FULLNAME = 'Olivia Gladstone',
				BIO =
				"Olivia Gladstone was the highest-ranking officer in the Pan-Euro Infosec Agency before it collapsed at the end of the Resource Wars.\n\nForced into hiding, she re-emerged as the founder and leader of Invisible Inc. She currently holds the record for highest total corporate bounty ever offered for a single target.",
				TOOLTIP = "The Leader",
			},
	...
	MISSIONS =
	{
		...
		CENTRAL_JUDGEMENT =
		{
			...
			VAULT = {
				...
				HARDLOOT =
				{
					"Excellent work, Operator. Now we have to find a way to spend our newfound fortune.",
		...
		LOCATIONS =
		{
			...
			DETENTION_CENTER = {
				...
				DESCRIPTION =
				"Make your way to the holding cells, and escort any prisoner back to to the telepad in order to escape.",
			...
			NANO_FAB = {
				...
				MORE_INFO =
				"This location contains an advanced Nanofab, providing a wide variety of tools that will help agents overcome more powerful security threats. Choose carefully to compliment their abilities and your strategy as an Operator.\n\nThese items do not come cheap, so you'll need to have saved significant credits to make use of it.",
				...
				REWARD =
				"Gain access to a wide variety of counterfeit goods. You'll need enough credits to make use of this.",
			},

			VAULT = {
				NAME = "Vault",
				MORE_INFO =
				"Vaults contain large sums of credits waiting to be stolen.\n\nHowever, the highest value items are behind locked doors, and if you are not bringing a vault access card into the mission, you will not be able to access it. You may need to infiltrate other missions to obtain it first.",
				INSET_TITLE = "CREDIT RESERVES",
				INSET_TXT =
				"This facility warehouses credit hashes.\n\nWe could siphon off a portion without triggering a hash recall.",
				DESCRIPTION = "Break into their high security vault.",
				REWARD =
				"Vaults hold credits and art objects that can be sold. Vault access cards will open the doors to greater riches.",
			},

			CEO_OFFICE = {
				NAME = "Chief Financial Suite",
				MORE_INFO =
				"The financial officer at this location holds pass codes for high value items in other locations. Infiltrating here may yield greater rewards for future locations.",
				INSET_TITLE = "FINANCIAL PASS CODE",
				INSET_TXT =
				"A highly-placed financial officer has an office in this facility.\n\nWith his access codes, we can manipulate the market to our advantage.",
			...
			CYBERLAB = {
				...
				MORE_INFO =
				"Cybernetic augments give passive abilities to agents, often yielding powerful combinations with other items and programs.\n\nThe machines at this location will provide you the opportunity to install an augment for free, or enhance an agent with an additional augmentation socket.",
				INSET_TITLE = "AUGMENTS",
				INSET_TXT =
				"This is a research and development lab for cybernetic augments.\n\nThe augments in storage there will not yet have been genecoded to specific users.",
				DESCRIPTION = "Find the augment grafting laboratory and hack into their machines.",
				REWARD =
				"Gain a one-time ability to either install free augments in an agent, or expand their capacity for augmentation.",
			},

			FINALMISSION = {
				NAME = "Mainframe",
				MORE_INFO =
				"There isn't a lot of information about this location, but Monst3r's intelligence show that the security here uses the most state-of-the art technology.\n\nExpect high level security and advanced countermeasures.",
				INSET_TITLE = "SECNET ROOT ACCESS",
				INSET_TXT =
				"This is the processing center that has been collating network traffic data from all of the corporations.\n\nWith their hardware, Incognita may be able to cover our tracks.",
	...
	PROGRAMS =
	{
		...
		INSTALLED = "P R O G R A M  I N S T A L L E D",
		INSTALLED_DESC = "You've installed a program to be used by Incognita:\n%s",
		...
		POWER_DRIP =
		{
			...
			MODAL_2 = "POWER DRIP",
			MODAL_3 =
			"Your agency has provided the Power Drip program for you. This program automatically generates 1 PWR at the start of each turn.",
		},
	...
	UI =
	{
		DLC_TAG = "From the {1} {2}",
		DLC_TAG_TYPE_EXPANSION = "expansion",
		DLC_TAG_TYPE_MOD = "mod",

		CONFIRMLASTWORDS =
		"If you are out of options, your agent can go down quipping.\n\nThis will terminate the mission if you are out of rewinds, but at least you will lose with style.",
		...
		TASWELL_INFO =
		"Ryan Davis (1979-2013) was a much respected video game journalist, and co-founder of Giant Bomb. He touched a lot of our lives through the years, and this is a small tribute to his legacy. We thank him for his contribution to the craft.\n\n-Klei Development Team",
		...
		{
			INTRO =
			"I need to get to the central processing center on the next floor. Lead us straight there, everything else is a distraction.",
		...
		LAST_MISSION =
		"Operator, choose your next target carefully - This is our last opportunity to prepare for our final stand.",
		...
		MAP_DIALOG_1 =
		"We need to keep moving - if the corps get a fix on our location, we won't last long in a direct fight.\n\nKeep up the hit-and-run, and we might just get through this.",
		--after general mission where the difficulty steps up
		CENTRAL_MISSION_DIFFICULTY =
		"Looks like we've stirred up the hornet's nest. The corps are aware of our presence and are doubling-down on their security. Your job just got a lot tougher.",
		...
		MONST3R =
		{
			...
			DAEMON_BLOCKER =
			"An ex-Sankaku executive smuggled this out, along with some intel I'm sending your way on a new type of Daemon. Don't thank me, I'm just keeping a customer alive.",
		...
		MODS_UPDATE = "REFRESH MODS",
		MODS_UPDATING = "UPDATING: %{1}",
		MODS_OFFLINE = "REFRESH MODS\n(OFFLINE)",
		MODS_REFRESH_COMPLETE = "Finished refreshing language packs from Steam Workshop.",
		MODS_REFRESH_SCHEDULED =
		"Mods and language packs will refresh the next time you start the game.\n\nIt may take several moments depending on the size of the mods.",
		...
		DIFFICULTYDESC =
		{
			...
			"Expect lethal resistance from the moment you enter the facility.",                      --"OMNI ALLY",
		},
		DIFFICULTY_OMNI = "Expect lethal resistance from the moment you enter the facility.",        -- Custom final mission text.
		DIFFICULTY =
		{
			"GUARDED",
			"VERY GUARDED",
		...
		NORMAL_DESC =
		"If you are new to Invisible, Inc. we suggest selecting this mode. This mode is designed to teach you the unique mechanics of the game, and will still provide a formidable challenge.",
		EXPERIENCED_DESC =
		"Now that you have a better hang of the game, the corporations are tougher and we're pulling away the safety net. No more level retries: your every action counts.",
		HARD_DESC =
		"This is the base difficulty and tuning for the game. It assumes you understand the mechanics of the game well, and pulls no punches.",
		VERY_HARD_DESC =
		"We hide the danger zones if you can't see the sources. In addition, the alarm increases when knocking out guards, and you start with less PWR.",
		ENDLESS_DESC =
		"There is no time limit and no end mission here, and the difficulty continues to rise as the days go by.\n\nHow long can you survive?",
		ENDLESS_PLUS_DESC =
		"No time limits, on the most difficult option settings. How long can you keep Invisible afloat?",
		TIME_ATTACK_DESC =
		"We're evening the playing field, and you only have 2 minutes to complete every turn. Are you able to act fast enough, or will the corporations get you first?",
		CUSTOM_DESC =
		"Change the campaign generation options as you prefer.\nClicking on another difficulty will reset the values to their default settings.",
		...
		REWIND_SUGGEST =
		"REWIND will revert the simulation back to the start of your previous turn.\n\nWould you like to do so now?",
		REWIND_GAME_OVER = "END CAMPAIGN",

		REGEN_LEVEL = "REGENERATE LEVEL",
		REGEN_LEVEL_BODY =
		"Regenerating the level will restart the current mission with a new level layout. Are you sure?",
		...
		PRERELEASE_COMPAT_BODY =
		"We have detected an Early Access save file. This file is not compatible with this version of the game, so it has been reset. We can, however, restore your XP for agent unlocks.\n\nWould you like to start fresh with the latest build, or keep your experience points?",
		PRERELEASE_COMPAT_TITLE = "SAVE GAME COMPATIBILITY",
		PRERELEASE_COMPAT_YES = "Keep XP",
		PRERELEASE_COMPAT_NO = "Start Fresh",

		MODS_UPDATED = "MODS AND LANGUAGE PACKS HAVE BEEN UPDATED",

		CAUGHT_MODAL_1 = "C A U G H T  B Y  A  G U A R D",
		CAUGHT_MODAL_2 = "GUARD OVERWATCH",
		CAUGHT_MODAL_3 =
		"A guard is about to shoot your agent. Your agent can quickly hide behind any cover within one square, or you can send another agent to give support.",
		...
		ALARM_FIREWALLS =
		"The corporation has installed firewall upgrades. All firewalls have increased in strength by +%d",
		ALARM_CAMERAS =
		"The corporation is activating additional cameras. You have one turn before they are fully activated.",
		ALARM_PATROLS = "The corporation has brought {1} more guard {1:patrol|patrols} into the building.",
		ALARM_BOOTING =
		"They've cracked Incognita's first layer of encryption. Be careful, the next alarm levels will be quite dangerous.",
		ALARM_ENFORCERS =
		"The corporation has called in {1} elite {1:enforcer|enforcers}. Their security has also pinpointed {2} agent {2:location|locations}.",

		ALARM_TOOLTIP =
		"<c:F4FF78>SECURITY LEVEL</>\nThe facility detected Incognita's disturbance as she beamed you in. They are slowly tracking her signal down, and raising their defences as it locks onto your team's location. New security measures are added every 5 increments.",
		ADVANCED_ALARM_TOOLTIP =
		"<c:a40000>ADVANCED SECURITY LEVEL</>\nThe corporations have elevated their response to intrusion due to your previous successes. These new security measures will activate every 5 increments as before.",
		ALARM_NEXT_BOOTING =
		...
		SCANNER_ALERT_TXT =
		"An advanced scanning amplifier has pinpointed your location. A guard has been sent to investigate.",

		ROUTER_ALERT = "ROUTER HAS REINFORCED A DEVICE\n+1 FIREWALL",
		...
		DATA_LOGS = "",
		SELECT_DATA_LOG = "SELECT DATA LOG",
		NO_DATA_LOGS =
		"ALL FILES ON THIS SUBJECT HAVE BEEN LOST DUE TO DUE TO CORPORATE SEIZURE OF DATA ASSETS.\n\nRECOMMEND CORPORATE DATA MINING TO RETRIEVE MISSING FILES.",
		DELETE_LOG_AREYOUSURE =
		"You may find a deleted data log again in the future.\n\nAre you sure you want to delete this data log?",
		...
		TOOLTIPS = {
			...
			ADVANCED_PERIPHERAL_BOOST = "ADVANCED PERIPHERAL BOOST",
			ADVANCED_PERIPHERAL_BOOST_DESC = "180 degree Line of Sight\n360 degree peripheral Sight",
			...
			MAGNETIC_REINFOREMENTS_DESC =
			"If this device has more than 2 FIREWALLS, EMP's break 2 FIREWALLS instead of disabling it.",
			...
			NULL_ZONE = "NULL ZONE",
			NULL_ZONE_DESC =
			"This drone emits a field which blocks hacking of firewalls in a range of {1} {1:tile|tiles}.",

			FOCUSED_AI = "FOCUSED AI",
			FOCUSED_AI_DESC = "This unit will not be distracted from its patrols or hunts.",

			PULSE_SCANNER = "PULSE SCANNER",
			PULSE_SCANNER_DESC =
			"Activated at the beginning of a turn. Targets located in or out of cover are relayed to nearby security. Range: {1}",

			AOE_FIREWALL_BUFF = "CYBER SCREAM",
			AOE_FIREWALL_BUFF_DESC =
			"Each time this unit is KOed or Alerted mainframe devices within {1} tiles get +{2} Firewalls",
			...
			SCAN_VULNERABLE = "VULNERABLE TO SCANS",
			SCAN_VULNERABLE_DESC =
			"Scans from such things as Drones and Scan Grenades will be inconclusive drawing attention to this agent.",
			...
			STACKABLE = "This effect will stack with other augments",
		...
		TOOLTIP_UNLIMITED_ATTACKS_DESC = "This agents has unlimited attacks.",
		...
		TOOLTIP_INACTIVE_DESC =
		"This camera is currently inactive. It will activate when the Security Level increases surveillance.",
		...
		SHOP_RESEARCH = "COMPILE COMPLETE",
		...
		RESEARCH_OPEN = {
			...
			"ADD TO TASK BAR? Y/N",
			"AUTO OPEN ON INSTALL? Y/N",
			"REQUIRES DIRECT.EX 25.0",
		},
		...
		HUD_CONFIRM_PARTIAL_ESCAPE =
		"Escaped agents can not re-enter the mission, and the teleporter will be on cooldown for a couple of turns after transport.\n\nAre you sure you want to leave now?",


		HUD_WARN_EXIT_EXECTERM =
		"Are you sure you want to leave? You don't have the contact list from the Executive Terminal.",
		...
		HUD_WARN_EXIT_DETENTION =
		"Are you sure you want to leave? You haven't freed the prisoner from the Detention Cells.",
		...
		AUGMENT_DRILL_MODAL_BODY =
		"<c:8AEFEF>Select an augment to drill out. This will destroy the Augment. <c:FF3300>(KO FOR 2 TURNS)</></>",
		...
		COMBAT_PANEL_KILL_KO_TARGET = "KO",
		...
		MAP_SCREEN_NET_WORTH_TOOLTIP =
		"The value of all of agents' upgrades, items, programs, and credits Invisible, Inc. owns.",
		...
		TEAM_SELECT =
		{
			...
			LOCKED_LOADOUT =
			"You've selected CLASSIFIED components to your team. Please select a team loadout that you have access to.",
		...
		{
			DELETE_AREYOUSURE =
			"If you complete the game or retire the agency, you will earn experience that unlocks new agents and programs. If you delete this save, you will lose the experience gained.\n\nAre you sure you want to delete this save slot?",
			...
			PLAYED_TUTORIAL =
			"It is recommended you play the tutorial the first time you play Invisible, Inc.\n\nDo you want to play the tutorial first?",
		...
		REASON =
		{
			NO_EQUIPPED_PROGRAM = "No equipped program",
			...
			MONST3R_REQUIRED =
			"Monst3r needs to manually open this after obtaining the security codes from the Security Hub.",
		...
		DOORS =
		{
			...
			SECURITY_LONGDESC =
			"Lvl1 security passcards can be stolen from the guards, and only work in the facility where they are found.",
			VAULT = "LOCKED - VAULT ACCESS CARD",
			VAULT_LONGDESC =
			"Vault Access Cards can be found by interrogating corporate executives in Financial Suite missions.",
		...
		DIALOGS =
		{
			...
			AUGMENT_MACHINE_BODY_2 =
			"<c:F4FF78>Install the %s</c> augment design. This function requires an open Augment Socket on the patient in order to be successful.",
			AUGMENT_MACHINE_3 = "INSTALL %s",
			AUGMENT_MACHINE_MAXED =
			"This agent has reached it's augment slot capacity and cannot install additional slots.",
	...
	CORP =
	{
		FTM =
		{
			...
			SHORTDESC =
			"FTM has advanced surveillance and scanning technology. You'll need to move fast in order to avoid detection.",
		...
		SANKAKU =
		{
			...
			SHORTNAME = "Sankaku",
			DESCRIPTION =
			"Sankaku started as an industrial automation provider in the early 21st century. In recent decades it has capitalized on the corporate class' growing dissatisfaction with human labour to expand into everything from education to law enforcement.",
		...
		OMNI =
		{
			...
			SHORTNAME = "OMNI",
			DESCRIPTION =
			"We don't know much about OMNI, but they appear to combine the most dangerous aspects of all of the world's leading corporate powers.",
			SHORTDESC =
			"We know very little about OMNI, but they appear to have more advanced technology than any other corporation.",
			THREATS = { "??", "??" },
		},
		...
		KO =
		{
			...
			SHORTDESC =
			"Free from government regulation, K&O has the most advanced weaponry and automated defenses of all the corporations.",
		...
		PLASTECH =
		{
			...
			SHORTNAME = "Plastech",
			DESCRIPTION =
			"Plastech Medical made record profits in the early 21st century selling life-extension technologies to aging baby boomers. When that well dried up, they funneled their vast cash reserves into R&D and cornered the market for cybernetic augmentation.",
	...
	ABILITIES = {
		...
		RECHARGE_CHARGES_DESC = "Use Charge Pack to charge the item again.",
		RESCUE = "Rescue",
	...
	ITEMS = {
		...
		TOOLTIPS = {
			...
			USE_CHARGES_DESC =
			"Each use of this item takes a charge. Recharges between missions. Use charge Packs to refill during missions.",
			...
			MELEE_BOOST_DESC = "+{1} ARMOR PIERCING and KO DAMAGE",
			...
			HEAVY_EQUIPMENT_DESC = "Carrying this item reduces AP by {1}",
		},
		...
		AUGMENTS = {
			...
			CENTRALS_FLAVOR =
			"The highly confidential work of a Daemon engineer, this subdermal chip re-routes PWR from other networked subroutines. Rumor has it that Central has the only prototype.",

			MONSTERS = "Fabricator Multithreading",
			MONSTERS_TIP = "Nanofabricator purchases cost 15% less.",
			MONSTERS_FLAVOR =
			"As an expert hacker and savvy tech opportunist, Monst3r has built a unique network of hyper efficient Nanofabricator coroutines.",
			...
			INTERNATIONALS_TIP =
			"Allows agent to hack items from a distance, through walls. Automatically reveals nearby mainframe objects.",             --talk about the range?
			INTERNATIONALS_FLAVOR =
			"Using her skin as an antenna, Internationale is able to manipulate electronics at a distance.",

			INTERNATIONALS_2 = "Network Siphon",
			INTERNATIONALS_2_TIP = "Generates PWR when ALARM LEVEL increases.\nPWR gained: 2x Alarm Level.",
			INTERNATIONALS_2_FLAVOR =
			...
			TONYS_FLAVOR =
			"Dr. Xu carries the tools of his trade in a purpose-built cavity in his prosthetic arm. Unfortunately, the large power capacitor needed to charge the EMP impairs Xu's stamina.",
			...
			PRISM_2_FLAVOR =
			"Collects ambient energy from data signals, most efficient during large flurries of network activity such as when firewalls come down.",
			...
			SHARP_1_FLAVOR =
			"In his reach to perfect the connection between mind and machine, Alex has converted nearly 90% of his body into a highly modular robotic frame.",

			SHARP_2 = "Modular Cybernetic Frame X2",
			SHARP_2_TOOLTIP =
			"Start with 6 augment slots.\nEach 3 augments installed gives melee weapons +1 ARMOR PIERCING. Agent's AP is reduced by 1",
			SHARP_2_FLAVOR =
			"Each of Alex's earlier MCF designs had their own share of advantages and disadvantages. The X2 had particularly useful benefits, but the bladder containment trouble proved to be too embarrassing.",
			...
			NIKAS_2_FLAVOR =
			"Nika loves scrambling neurons so much, she had a tech write a custom routine that makes her disrupter recharge itself and everything around it.",

			SADOCHISTIC_PUMPS = "Sadochistic Pumps",
			SADOCHISTIC_PUMPS_TIP = "Killing adds 6 AP",
			SADOCHISTIC_PUMPS_FLAVOR =
			...
			HOLOCIRCUIT_TIP = "Knock out all enemies in a small area around this agent. 2 turn KO.",
			HOLOCIRCUIT_FLAVOR =
			"Modern tactical displays stream terabytes of situational data directly into the corneas of security forces. They also provide an avenue of attack.",
			...
			CHAMELEON_MOVEMENT_FLAVOR =
			"Contrary to its name, the Chameleon Movement implant does not allow the host to change their appearance. Rather - it analyzes their surroundings to show them the most inconspicuous path for the way they look.",
			...
			PENETRATION_SCANNER_FLAVOR =
			"A suite of sensors and AI routines that analyze weaknesses in blunt trauma armor.",

			CARBON_MYOMER = "Carbon Myomer",
			CARBON_MYOMER_TIP = "Agent can carry one more item easily.",
			CARBON_MYOMER_FLAVOR =
			"Replacement Myomer bundles that produce an accessible compartment in unused body space.",

			SKELETAL_SUSPENSION = "Skeletal Suspension",
			SKELETAL_SUSPENSION_TIP = "Improves the speed of dragging",
			SKELETAL_SUSPENSION_FLAVOR =
			"Nano constructed fiber webbing surrounds the bones, vastly reducing the risk of arthritis.",
		...
		REVOLVER_DECKARD_FLAVOR =
		"An old revolver that has been extensively refurbished to work nearly as well as modern plasma gun. Each bullet is an irreplaceable hand-made plasma composite.",

		--AP gun
		PISTOL_DAM = "Cooker",
		PISTOL_DAM_TOOLTIP = "Ranged targets. Lethal damage.",
		PISTOL_DAM_FLAVOR =
		"The cooker bypasses even thicker armor by adding a negative counter-charge to the standard plasma bolt.",
		...
		PISTOL_ENERGY_TOOLTIP =
		"Infinite ammo. Can only be fired for one turn per mission. Still consumes an agent's attack. Lethal damage",
		PISTOL_ENERGY_FLAVOR =
		...
		GRENADE_SMOKE_FLAVOR =
		"The jet-black smoke not only occludes vision, but overpowers smell with the harsh odour of burnt circuit board.",
		...
		PARALYZER_BANKS_FLAVOR =
		"Banks perfected this recipe during her time doing solo corporate heists. After dozens of successful jobs and no fatalities, she was hailed as a modern Robin Hood.",
		...
		CLOAK_3_TOOLTIP =
		"Renders the user invisible until their next turn or if they attack. When used, also renders nearby agents in a small area invisible.",
		...
		BUSTER_1_FLAVOR =
		"A favourite of script kiddies and low-level corporate sysadmins, the Buster Chip automatically breaks down firewalls.",
		...
		TAZER_DECKARD_FLAVOR =
		"Always the paranoid type, Decker modded his disrupter to implant a subdermal tracking chip in its victims.",
		...
		EMP_TONY_TOOLTIP =
		"Detonates at the end of the turn. Disables all Mainframe devices and drones in a range of 3 tiles",
		...
		"Detonates at the end of the turn. Disables all Mainframe devices and drones in a range of 3 tiles",
		EMP_1_FLAVOR =
		"An EMP pack generates a large static charge in the air, scrambling electronics within a radius. Often used as safety devices in automated assembly lines.",

		EMP_2 = "EMP Pack II",
		EMP_2_TOOLTIP =
		"Detonates at the end of the turn. Disables all Mainframe devices and drones in a range of 5 tiles",
		EMP_2_FLAVOR =
		"An EMP pack generates a large static charge in the air, scrambling electronics within a radius. Often used as safety devices in automated assembly lines.",

		EMP_3 = "EMP Pack III",
		EMP_3_TOOLTIP =
		"Detonates at the end of the turn when primed. Disables all Mainframe devices and drones in a range of 7 tiles",
		EMP_3_FLAVOR =
		"An EMP pack generates a large static charge in the air, scrambling electronics within a radius. Often used as safety devices in automated assembly lines.",

		VAULT_PASS = "Vault Access Card",
		VAULT_PASS_TOOLTIP =
		"Opens the special high-security vault doors in corporate vault and cybernetics lab locations.",
		...
		INCOGNITA_DRIVE_FLAVOR =
		"Quantum shadow recursion allows for the entirety of Incognita's personality matrix to be stored on a standard data drive, but it degrades over time.",

		COMPILER_KEY = "Compile Key",
		COMPILER_KEY_TOOLTIP = "Use on a research console to compile new software.",
		COMPILER_KEY_FLAVOR =
		"A physical security feature to help stop network theft. Good thing neural disrupters are all physical.",
		...
		DAEMON_BLOCKER_FLAVOR =
		"The corporations are working on a dangerous prototype Daemon. Thankfully, according to our intel, it doesn't sound like they'll be active in the standard facilities.",
		...
		DEFIBRILLATOR_FLAVOR =
		"A cardiac shot of aggression straight to the heart. Be sure to punch clean through the rib cage for positive results.",

		SCAN_CHIP = "SCAN CHIP",
		SCAN_CHIP_TOOLTIP = "Reveals hidden Daemons and identifies its type on mainframe device.",
		SCAN_CHIP_FLAVOR =
		"Initially a 'search and destroy' virus protection device, its software development team could not keep up in the virtual space cold war. It still makes for a useful diagnostic tool.",
	...
	PROPS = {
		...
		ARTIFACT_DESC =
		"An ongoing science project. The black market will pay well for its secrets.\n\nBring it with you when you exit the level.",
	...
	{
		ERR_BODY =
		"There was an error loading. Pressing CONTINUE will load to the state before the error occurred.\n<font1_10_r>\n{1}</>",
		ERR_TITLE = "OOPS!",
	...
	OPTIONS =
	{
		...
		"We require the collection of user data to assist in improving game operations. Players who opt out of data collection will no longer send crash reports and user data to the game team.\n\nFor more details on our privacy policy and how we use the data we collect, please see our official privacy policy.",
		DATA_COLLECTION_OK = "CLOSE",
		DATA_COLLECTION_VISIT = "VIEW PRIVACY POLICY",
	},
	...
	LOADING_TIP_TUTORIAL =
	"Missing agent located: Decker, Brian. Initializing failsafe neural tap. Operator interface ready in 3...2...1...",
	LOADING_TIP_FIRST =
	"You'll never survive a stand-up fight with the corps, so don't give them one. Stick to cover and stay out of sight.",
	...
	MOVIE_SUBS = {
		...
		END_9 = "There you are.",
		END_10 = "<c:FF8C00>Warning, security personnel have been notified and are en route.</>",
		...
		END_32 =
		"One minute the combined security apparatus of 4 megacorps is bearing down on us\n and the next SecNet is gone.",
