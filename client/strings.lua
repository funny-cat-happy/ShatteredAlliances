...
local STRINGS=
{
	...
	AGENTS = 
	{
		...
		INTERNATIONALE = {
			...
			BIO_SPOKEN = "Internationale is one of the best all-round operatives I've ever seen, but she's held back by an unfortunate abundance of social concern. If used correctly, she's the bedrock upon which you can build a winning team. Just don't ask her about the plight of the global proletariat.",
			...
			BANTER = {
				...
				CROSS = {	
					...
					[23] = "It must have been demeaning to prioritize another's life ahead of your own for money. How did that feel?",
					...
					[28] = "But don't you recognize the structural biases that have allowed you to pursue your goals at the expense of others?",
					[29] = "I want a new partner.",

					-- PRISM
					[30] = "You were involved in the anti-corporate movement when you were younger?",
					[31] = "But we should talk about it! You could have used your fame as a platform for changing public consciousness!",

					[32] = "I enjoy reading. I particularly enjoy early 20th century proletarian novels. Have you read Upton Sinclair?",

					[33] = '"Corporate Hegemony and the Praxis of Action". A classic! I must have dropped it. You can borrow it if you\'d like.',
					...
					[37] = "They're synesthetic couplers. They let me hear radio waves, so I can sense equipment from a distance.",
		...
		BANKS = {
			...
			BANTER = {
				...
				CROSS = {	
					...
					[21] = "No, not the story. The person. I could introduce you, if you'd like. I think you'd get along smashingly.",
		...
		NIKA = {
			...
			BANTER = {
				...
				CROSS = {	
					...
					[27] = "I enjoy working with you. It is good that you were never paid to eliminate someone under my protection.",
		...
		SHARP = {
			...
			BANTER = {
				...
				CROSS = {	
					...
					--INTERNATIONALE 
					[15] = "Your obsession with the downtrodden is a waste of time. The only thing deserving of respect is power.",
					[16] = "Why would I care?",
					...
					[26] = "You could improve your kill ratio with a couple of augmentations. An external tracking eye, for example, to better analyze ballistics.",
					[27] = "You can get synthetic skin like mine, and never have to shave again!",

					[28] = "Today is a good day. Let’s kill some people!",
					[29] = "You don’t feel a little rush when you take a human life? It’s like popping bubble wrap to me!",
		...
		PRISM = {
			...
			BANTER = {
				...
				CROSS = {	
					...
					[15] = "Wow - where were you when I was looking for a new agent? My guy just wanted me to take big roles in popular 'vids. Clearly I was misled.",

					[16] = "So what do you do for fun?",
					[17] = "Oh, I'm sorry,  you must have misheard. I was asking about 'fun', not.. whatever you were talking about.",
	...
	UI =
	{
        ...
        MODS_REFRESH_SCHEDULED = "Mods and language packs will refresh the next time you start the game.\n\nIt may take several moments depending on the size of the mods.",
        ...
        NO_DATA_LOGS = "ALL FILES ON THIS SUBJECT HAVE BEEN LOST DUE TO DUE TO CORPORATE SEIZURE OF DATA ASSETS.\n\nRECOMMEND CORPORATE DATA MINING TO RETRIEVE MISSING FILES.",
        DELETE_LOG_AREYOUSURE = "You may find a deleted data log again in the future.\n\nAre you sure you want to delete this data log?",
		...
		TOOLTIPS = {
			...
			SCAN_VULNERABLE_DESC = "Scans from such things as Drones and Scan Grenades will be inconclusive drawing attention to this agent.",
	...
	ITEMS = {
		...
		TOOLTIPS = {
			...
			USE_CHARGES_DESC = "Each use of this item takes a charge. Recharges between missions. Use charge Packs to refill during missions.",			
		...
		AUGMENTS = {
			...
			CENTRALS_FLAVOR = "The highly confidential work of a Daemon engineer, this subdermal chip re-routes PWR from other networked subroutines. Rumor has it that Central has the only prototype.",
			...
			SHARP_2_FLAVOR ="Each of Alex's earlier MCF designs had their own share of advantages and disadvantages. The X2 had particularly useful benefits, but the bladder containment trouble proved to be too embarrassing.",
			...
			CHAMELEON_MOVEMENT_FLAVOR = "Contrary to its name, the Chameleon Movement implant does not allow the host to change their appearance. Rather - it analyzes their surroundings to show them the most inconspicuous path for the way they look.",
			...
			CARBON_MYOMER_FLAVOR = "Replacement Myomer bundles that produce an accessible compartment in unused body space.",

			SKELETAL_SUSPENSION = "Skeletal Suspension",
			SKELETAL_SUSPENSION_TIP = "Improves the speed of dragging", 
			SKELETAL_SUSPENSION_FLAVOR = "Nano constructed fiber webbing surrounds the bones, vastly reducing the risk of arthritis.",
		...
		MED_GEL_FLAVOR = "A Medgel capsule contains a swarm of cellular-restoration nanobots suspended in a slurry of nutrients, antibiotics, and synthetic blood vessels. They taste like guava.",
    ...
    LOADING =
    {
        ERR_BODY = "There was an error loading. Pressing CONTINUE will load to the state before the error occurred.\n<font1_10_r>\n{1}</>",
        ERR_TITLE = "OOPS!",
    ...
    OPTIONS =
    {
		...
		DATA_COLLECTION_BODY = "We require the collection of user data to assist in improving game operations. Players who opt out of data collection will no longer send crash reports and user data to the game team.\n\nFor more details on our privacy policy and how we use the data we collect, please see our official privacy policy.",
    ...
    MOVIE_SUBS ={
        ...
        END_32 = "One minute the combined security apparatus of 4 megacorps is bearing down on us\n and the next SecNet is gone.",
