...
local CellCoverage =
{
	...
	[ BoundType.Floor_1x4 ]				=  { {0,0}, {0,1}, {0,2}, {0,3} },	
}
...
Bounds[ BoundType.Floor_1x4 ] =
{
	[0] = { mx = -A1, my = -A1, mz = 0, MX =(A1+3), MY = A1, MZ = D0, iso_dim = iso_dim, backX =  0, backY =  0, frontX =  3, frontY =  0 },
	[2] = { mx = -A1, my = -(A1+3), mz = 0, MX = A1, MY = A1, MZ = D0, iso_dim = iso_dim, backX = 0, backY =  -3, frontX =  0, frontY =  0 },
	[4] = { mx = -(A1+3), my = -A1, mz = 0, MX = A1, MY =A1, MZ = D0, iso_dim = iso_dim, backX =  -3, backY = 0, frontX =  0, frontY =  0 },
	[6] = { mx = -A1, my = -A1, mz = 0, MX = A1, MY =  (A1+3), MZ = D0, iso_dim = iso_dim, backX =  0, backY =  0, frontX =  0, frontY =  3 },
}
