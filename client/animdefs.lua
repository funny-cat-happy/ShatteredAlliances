...
-----------------------------------------------------------------------------------------
	...
	kanim_drone_null_SA =
	{
		...
		anims =
		{		
			"data/anims/characters/corp_SK/sankaku_droid_null_basic.adef",
		},
		anims_1h =
		{
			"data/anims/characters/corp_SK/sankaku_droid_null_basic.adef",
	...
	kanim_magnetic_resistance_fx =
	{
		build = { "data/anims/fx/magnetic_resistance_fx.abld" },
		anims = { "data/anims/fx/magnetic_resistance_fx.adef" },
		anim = "loop",
		scale = 0.25,
		layer = Layer.Unit,
		boundType = BoundType.Character, -- this doesn't really apply to HUD stuff...
