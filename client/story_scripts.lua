...
local STORY_SCRIPTS_DEFAULT = 
{
    ...
    INGAME = 
    {
       ...
       TUTORIAL_INTRO = {
        ...
        CENTRAL_SCANNERS_DETECTED =
        {
            Central(STRINGS.MISSIONS.ESCAPE.OPERATOR_SCANNERS_DETECTED_1, "SpySociety/VoiceOver/Central/Scanner/DLC_Central_50_GMS_ScannersDetected_1" ),
            Central(STRINGS.MISSIONS.ESCAPE.OPERATOR_SCANNERS_DETECTED_2, "SpySociety/VoiceOver/Central/Scanner/DLC_Central_51_GMS_ScannersDetected_2" ),          
        },
        CENTRAL_SCANNERS_DETECTED_2 ={ Central(STRINGS.MISSIONS.ESCAPE.OPERATOR_SCANNERS_DETECTED_3, "SpySociety/VoiceOver/Central/Scanner/DLC_Central_51_GMS_ScannersDetected_3" )},        
