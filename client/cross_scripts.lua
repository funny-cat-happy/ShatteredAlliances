...
return 
{
    ...
    {id = 52,
     ...
     dialogue = {  -- agent IDs                        
        {SHALEM,            18},  -- agnetID and BANTER.CROSS line                                                   
        {INTERNATIONALE,                 15},            
        {SHALEM,            19},    
        }
    }, 
    ...
    {id = 55,
     agents = {INTERNATIONALE,SHALEM},
     dialogue = {  -- agent IDs                        
        {SHALEM,            23},  -- agnetID and BANTER.CROSS line                                                   
        {INTERNATIONALE,                 19},            
        {SHALEM,            24},    
        }
    }, 
    ...
    {id = 56,
     ...
     dialogue = {  -- agent IDs                        
        {NIKA,            17},  -- agnetID and BANTER.CROSS line                                                   
        {INTERNATIONALE,                 20},            
        {NIKA,            18},    
        }
    }, 
    ...
    {id = 57,
     agents = {INTERNATIONALE,NIKA},
     dialogue = {  -- agent IDs                        
        {NIKA,            19},  -- agnetID and BANTER.CROSS line                                                   
        {INTERNATIONALE,                 21},            
        {NIKA,            20},    
        }
    },   
    ...
    {id = 58,
     ...
     dialogue = {  -- agent IDs                        
        {INTERNATIONALE,                 22},            
        {NIKA,            21},  -- agnetID and BANTER.CROSS line                                                   
        {INTERNATIONALE,                 23},            
        {NIKA,            22},    
        }
    },   
