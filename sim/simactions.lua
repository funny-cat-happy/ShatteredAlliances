...
local function doTradeItem( sim, unitID, shopUnitID, itemIndex, discount, itemType, buyback )
...
local function doTradeAbility( sim, index, unitID)
	local player = sim:getCurrentPlayer()
...
return
{
	...
	tradeItem = doTradeItem,
	buyItem = doBuyItem,
	sellItem = doSellItem,
	sellAbility = doSellAbility,
	tradeAbility = doTradeAbility,
