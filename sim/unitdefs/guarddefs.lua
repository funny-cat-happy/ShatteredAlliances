...
local default_npc_templates =
{
	...
	drone_akuma = 
	{
		...
		upgradeOverride = {"0.17.9","drone_akuma_17_9"}

	},	

	-- old Akuma was missing the lookaroundrange
	drone_akuma_17_9 = 
	{
		type = "simdrone",
		name = STRINGS.GUARDS.AKUMA_DRONE,
...
for id, template in pairs(default_npc_templates) do
	template.id = id
end

function ResetGuardDefs()
	log:write("ResetGuardDefs()")	
	util.tclear(npc_templates)
	util.tmerge(npc_templates, default_npc_templates)
