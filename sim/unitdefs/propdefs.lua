...
local prop_templates_default =
{
	...
	{ 
		...
		traits = util.extend( MAINFRAME_TRAITS ) {	moveToDevice=true, cover = true, impass = {0,0}, sightable = true, mainframe_no_recapture = true, generateAugment=true },
	...
	{ 
		...
		traits = util.extend( MAINFRAME_TRAITS ) {	moveToDevice=true, cover = true, impass = {0,0}, sightable = true, mainframe_no_recapture = true, drill=true, generateAugment=true  },
	...
	research_processor = 
	{
		...
		abilities = { "showItemStore" },
		traits = util.extend( MAINFRAME_TRAITS )
			{ moveToDevice=true, cover = true, impass = {0,0}, storeType="blank", sightable=true, research_program=true, noMandatoryItems = true, research_processor=true, emptyString=STRINGS.UI.REASON.NO_PROGRAMS },
		sounds = {appeared="SpySociety/HUD/gameplay/peek_positive", reboot_start="SpySociety/Actions/reboot_initiated_generator",reboot_end="SpySociety/Actions/reboot_complete_generator" }
	},
