	...
	DEFAULT_ABILITY =
	{
		...
		onTooltip = function( self, screen, sim, player )
			...
			if self.equipped then
	   		...
	   		section:addAbility( util.sformat(self.shortdesc,self.break_firewalls), util.sformat(self.desc,self.break_firewalls), "gui/icons/action_icons/Action_icon_Small/icon-item_shoot_small.png" )
